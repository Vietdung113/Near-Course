...
var CONTRACT_NAME = "dev-1636744715309-98477386575199" || 'new-app';
  ...
  switch (env) {
    ...
    case 'local':
      return {
        ...
        keyPath: "".concat("/home/mrdung", "/.near/validator_key.json"),
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "45195" + '/');
